...
export const StateContexts = {
  ...
  reflex___state____state__my_resume___projects____connection_calculations_state: createContext(null),
...
export function StateProvider({ children }) {
  ...
  const [reflex___state____state__my_resume___projects____connection_calculations_state, dispatch_reflex___state____state__my_resume___projects____connection_calculations_state] = useReducer(applyDelta, initialState["reflex___state____state.my_resume___projects____connection_calculations_state"])
  ...
  const dispatchers = useMemo(() => {
    return {
      ...
      "reflex___state____state.my_resume___projects____connection_calculations_state": dispatch_reflex___state____state__my_resume___projects____connection_calculations_state,
  ...
  return (
    ...
    createElement(StateContexts.reflex___state____state__my_resume___projects____connection_calculations_state,{value: reflex___state____state__my_resume___projects____connection_calculations_state},
